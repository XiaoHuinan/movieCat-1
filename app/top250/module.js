  ...
  angular.module("moviecat.top250", ["ngRoute"])
    ...
    .controller("Top250Controller", [
      ...
      function($scope, $http, JSONPSvr, $routeParams, $route){
        ...
        // https://api.douban.com/v2/movie/top250?count=1&start=0&callback=myCallback
        JSONPSvr.jsonp("https://api.douban.com/v2/movie/top250", {count:$scope.pageSize,start:start}, function(data){
          $scope.movie = data;
